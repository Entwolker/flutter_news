...
List<CategoryModel> getCategories() {
  ...
  categoryModel.category = CategoryType.business;
  ...
  categoryModel.category = CategoryType.entertainment;
  categories.add(categoryModel);
  ...
  categoryModel.category = CategoryType.general;
  categories.add(categoryModel);
  ...
  categoryModel.category = CategoryType.health;
  categories.add(categoryModel);
  ...
  categoryModel.category = CategoryType.science;
  categories.add(categoryModel);
  ...
  categoryModel.category = CategoryType.sports;
  categories.add(categoryModel);
  ...
  categoryModel.category = CategoryType.technology;
  categories.add(categoryModel);
